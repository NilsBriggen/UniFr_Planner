...
export const catalogueMessages = {
  de: {
    ...
    preview: "Veröffentlichte Termine ansehen",
    otherTerms: "Andere veröffentlichte Semester",
    sourceRecords: "Veröffentlichte Quelldaten und Ausnahmen",
    close: "Schliessen",
  ...
  fr: {
    ...
    preview: "Voir les dates de cours publiées",
    otherTerms: "Autres semestres publiés",
    sourceRecords: "Données et exceptions publiées par la source",
    close: "Fermer",
  ...
  en: {
    ...
    preview: "View published meeting dates",
    otherTerms: "Other published terms",
    sourceRecords: "Published source records and exceptions",
    close: "Close",
